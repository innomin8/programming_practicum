...
level_2.set_back('background1.jpg')
...
level_2.add_enemy(2, 400, 410, 350, 500, 2)  # Новый тип (2) - сильный враг
level_2.add_enemy(2, 600, 310, 550, 700, 1)  # Еще один сильный враг
level_2.add_platform(0, 550, 300, 100, 35, 0, 0)
level_2.add_platform(900, 250, 300, 250, 5, 0, -3)
level_2.set_goal(1500, 380)
